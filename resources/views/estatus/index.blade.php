                    ...
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <div class="mt-4">
                                ...
                                <button class="btn btn-soft-danger waves-effect waves-light eliminarEstatus" data-id="{{ $estatu->id }}"><i class="mdi mdi-trash-can-outline font-size-16 text-danger me-1"></i>Eliminar</button>
                            </div>
                        </div>
                    </div>
                </div>
