...
{{--  <div class="row col-md-12">
    <div class="col-lg-4" id="inspeccionVehiculo">
        <div class="card bg-primary text-white-50">
            <div class="card-body text-center">
                ...
                <h1 class="mt-0 mb-4 text-white"> Inspección de Vehículos </h1>
            </div>
        </div>
    </div>
    <div class="col-lg-4">
        <div class="card bg-primary text-white-50">
            <div class="card-body text-center">
                <i class="mdi mdi-car me-3 text-white" style="font-size: 100px;"></i>
                <h1 class="mt-0 mb-4 text-white"> Venta de Marbetes </h1>
            </div>
        </div>
    </div>
    <div class="col-lg-4">
        <div class="card bg-primary text-white-50">
            <div class="card-body text-center">
                <i class="mdi mdi-car me-3 text-white" style="font-size: 100px;"></i>
                <h1 class="mt-0 mb-4 text-white"> Impresión de Licencias </h1>
            </div>
        </div>
    </div>
    <div class="col-lg-4">
        <div class="card bg-success text-white-50">
            <div class="card-body text-center">
                <i class="mdi mdi-car me-3 text-white" style="font-size: 100px;"></i>
                <h1 class="mt-0 mb-4 text-white"> Notificaciones (NOTI) </h1>
    ...
    <div class="col-lg-4">
        <div class="card bg-success text-white-50">
            <div class="card-body text-center">
                <i class="mdi mdi-car me-3 text-white" style="font-size: 100px;"></i>
                <h1 class="mt-0 mb-4 text-white"> Certificación de Venta o Multa </h1>
    ...
    <div class="col-lg-4">
        <div class="card bg-success text-white-50">
            <div class="card-body text-center">
                <i class="mdi mdi-car me-3 text-white" style="font-size: 100px;"></i>
                <h1 class="mt-0 mb-4 text-white"> Seguro </h1>
