            ...
            <div class="modal-body">
                <div class="row col-md-12">
                    @foreach ($licencias as $licencia)
                        <button type="button" class="btn btn-soft-success col-md-3 waves-effect waves-light" style="margin: 1px;" data-id="{{ $licencia->id}}">{{ $licencia->nombre}}  ${{ $licencia->costo}}</button>
                    @endforeach
                </div>
            </div>
        </div>
